#pragma checksum "E:\ChatGPT\ChatGPT\ChatGPT_Wx\Areas\ChatGPT\Views\AI\GPT3_5Voice.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "7642376a228a9611229bf325da0822cdd2126473"
// <auto-generated/>
#pragma warning disable 1591
[assembly: global::Microsoft.AspNetCore.Razor.Hosting.RazorCompiledItemAttribute(typeof(AspNetCore.Areas_ChatGPT_Views_AI_GPT3_5Voice), @"mvc.1.0.view", @"/Areas/ChatGPT/Views/AI/GPT3_5Voice.cshtml")]
namespace AspNetCore
{
    ...
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"7642376a228a9611229bf325da0822cdd2126473", @"/Areas/ChatGPT/Views/AI/GPT3_5Voice.cshtml")]
    #nullable restore
    public class Areas_ChatGPT_Views_AI_GPT3_5Voice : global::Microsoft.AspNetCore.Mvc.Razor.RazorPage<dynamic>
    #nullable disable
    {
        #line hidden
        ...
        {
#nullable restore
#line 1 "E:\ChatGPT\ChatGPT\ChatGPT_Wx\Areas\ChatGPT\Views\AI\GPT3_5Voice.cshtml"
...
#nullable disable
            ...
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("head", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "7642376a228a9611229bf325da0822cdd21264732993", async() => {
                WriteLiteral(@"
...
");
  ...
  ");
            ...
            WriteLiteral("\r\n\r\n");
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("body", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "7642376a228a9611229bf325da0822cdd21264737756", async() => {
                WriteLiteral(@"
    <div id=""app"" v-cloak>
        <div id=""scroll"" style=""width: 100%; float: left; max-height: 100%;"" class=""scroll-container"">
            <div class=""div_AI"">
                ...
                <div class=""AI_Msg"">
                    ...
                    <van-icon name=""volume-o"" style=""margin-left:20px;margin-top:5px;"" ");
                WriteLiteral(@"@click=""read(Bot.Greetings)""></van-icon>
                </div>
            </div>
            <div v-for=""(item,index) in messages"" :key=""index"">
                ...
                WriteLiteral(@"gle""></p>
                        ...
                        <van-icon name=""volume-o"" style=""margin-left:20px;margin-top:5px;"" ");
                WriteLiteral(@"@click=""read(item.content)""></van-icon>
                    </div>
                </div>
            </div>
            <div class=""bottom"">
        ...
        <van-popup v-model=""Speak.show"" position=""top"" :style=""{ height:'240px' }"">
            ...
            <van-cell>
                ...
                <template>
                    ...
                    <van-slider v-model=""Speak.pitch"" :max=""2"" :min=""0"" :step=""0.1""></van-sli");
                WriteLiteral(@"der>
                </template>
            </van-cell>
            <van-cell>
    ...
    window.MyVue = new Vue({
        ...
        methods: {
            ...
            read(val) {
                ...
                let speake");
            WriteLiteral(@"r = new window.SpeechSynthesisUtterance();
            ...
            contion() {
                ...
                axios({
                    ...
                    that.apiUrl = res;
                    that.connection =");
            WriteLiteral(@" new signalR.HubConnectionBuilder().withUrl(res + '/chatHub3_5').build();
                    ...
                    that.connection.on(""EndMessage"", function (botID, message) {
                      ...
                      ");
            WriteLiteral(@"      SmoothVerticalScrolling(that.scroll, 500, ""center"");
                        }, 200);
                    });
            ...
            Send() {
                ...
                axios({
                    method: 'post',
       ");
            WriteLiteral(@"             url: '/ChatGPT/AI/Check',
                    data: formData,
                    headers: {
                        'Content-Type': 'application/json; charset=UTF-8',
                        'No-Loding': true
                    ...
                    setTimeout(() => {
    ");
            WriteLiteral(@"                    SmoothVerticalScrolling(msg, 500, ""center"");
                    }, 200);
                }).catch((err) => {
                    console.log(err);
                    if (err.indexOf('会员') != -1) {
...
<script>
    ...
    var Length = function () {
       ...
       ");
            WriteLiteral(@"     times = params.duration.toFixed(2);
    ...
    function initEvent() {
        ...
        bt_recoding.addEventListener(""touchmove"", function (event) {
            event.preventDefault();//阻止浏览器默认行为
           ");
            WriteLiteral(@" posMove = event.targetTouches[0].pageY;//获取滑动实时坐标
        ...
        bt_recoding.addEventListener(""touchend"", function (event) {
            ...
            windo");
            WriteLiteral(@"w.MyVue.VoiceText = ""按下 说话"";
            if (posStart - posEnd < 200) {
                ...
                axios({
                    method: 'post',
                    url: window.MyVue.apiUrl + '/api/Values',//调用接口语音转文字
                    data: form,
                    headers: {
                        'Content-Type': 'application/json; charset=UTF-8'
                    },
